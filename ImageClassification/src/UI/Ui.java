...
public class Ui {
   ...
   // private VG16ForCat vg16ForCat;
    ...
    public void initUI() throws Exception {
		...
		/*
		 * vg16ForCat = new VG16ForCat(); vg16ForCat.loadModel();
		 */
        // create main frame
		...
		/*
		 * predictButton.addActionListener(e -> { try { PetType petType =
		 * vg16ForCat.detectCat(selectedFile, (Double) thresholdField.getValue()); if
		 * (petType == PetType.CAT) { predictionResponse.setText("It is a Cat");
		 * predictionResponse.setForeground(Color.GREEN); } else if (petType ==
		 * PetType.DOG) { predictionResponse.setText("It is a Dog");
		 * predictionResponse.setForeground(Color.GREEN); } else {
		 * predictionResponse.setText("Not Sure...");
		 * predictionResponse.setForeground(Color.RED); } mainPanel.updateUI(); } catch
    ...
    private void addSignature() {
        JLabel signature = new JLabel("", JLabel.HORIZONTAL);
